...
/**
 * Get vendor's estimated shipping time by id.
 *
 * @param int $company_id Company id
 * @return mixed estimated shipping time
 */
function fn_get_estimated_shipping_time($company_id)
{
    $value = db_get_field("SELECT value FROM ?:profile_fields_data WHERE object_id = ?i AND field_id = 57", $company_id);
