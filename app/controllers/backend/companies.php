...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($mode == 'update') {
        ...
        $vendor_estimated_shipping_time = $company_data['fields']['57'];
        // update estimated shipping time feature
        fn_update_estimated_shipping_time_feature($company_id, $vendor_estimated_shipping_time);   
    ...
    if (fn_allowed_for('ULTIMATE')) {
        ...
        if ($mode === 'update' || $mode === 'add') {
            ...
            if ($company_id) {
                ...
                $current_style = Styles::factory($storefront->theme_name)->get($layout['style_id'])['name'];
            }
