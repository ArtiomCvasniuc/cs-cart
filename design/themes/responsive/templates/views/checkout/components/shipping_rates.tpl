...
{hook name="checkout:shipping_rates"}
    ...
    {foreach $product_groups as $group_key => $group}
        {if $product_groups|count > 1}
            ...
            <div class="litecheckout__group">
                {assign var="estimated_shipping_time" value=$group.company_id|fn_get_estimated_shipping_time}
        ...
        <div class="litecheckout__group">
            ...
            {if $group.shippings && !$group.all_edp_free_shipping && !$group.shipping_no_required}
                ...
                {foreach $group.shippings as $shipping}
                    ...
                    {assign var="orders_count" value=$user_id|fn_get_orders_count}
                    {if $orders_count == 0}
                        {assign var="company_id" value=$group.company_id}
                        {assign var="first_order_free_shipping" value=$company_id|fn_free_shipping_first_order}
                    {/if}
