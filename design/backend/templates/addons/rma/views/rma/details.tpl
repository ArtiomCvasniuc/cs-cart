        ...
        {if $return_info.proof}
            {foreach from=$return_info.proof item="name" key="idx"}
                <li class="proof_thumb_item">
                    <a href="admin.php?dispatch=rma.proof&return_id={$return_info.return_id}&file_name={$name}" data-standard="admin.php?dispatch=rma.proof&return_id={$return_info.return_id}&file_name={$name}">
                        <img data-standard="admin.php?dispatch=rma.proof&return_id={$return_info.return_id}&file_name={$name}" src="admin.php?dispatch=rma.proof&return_id={$return_info.return_id}&file_name={$name}" />
                    </a>
                </li>
            {/foreach}
        {/if}
