...
{capture name="tabsbox"}
    ...
    <div id="content_general_{$id}">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <textarea id="elm_plan_description_{$id}" name="plan_data[description]" cols="55" rows="2" class="input-textarea-long">{$plan.description}</textarea>
            </div>
        </div>
    ...
    <div id="content_commission_{$id}">
        ...
        {hook name="vendor_plans:transaction_fee"}
        <div class="control-group">
