<?php /* Smarty version Smarty-3.1.21, created on 2020-10-23 12:59:41
         compiled from "C:\xampp\htdocs\test-ro\design\themes\responsive\templates\blocks\list_templates\grid_list.tpl" */ ?>
<?php /*%%SmartyHeaderCode:14760187605f92a98d771713-75336975%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '61459e8ab9f30cecc759c65121667d9508d8da6e' => 
    array (
      0 => 'C:\\xampp\\htdocs\\test-ro\\design\\themes\\responsive\\templates\\blocks\\list_templates\\grid_list.tpl',
      1 => 1603102301,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '14760187605f92a98d771713-75336975',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5f92a98d877954_85284299',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f92a98d877954_85284299')) {function content_5f92a98d877954_85284299($_smarty_tpl) {?><?php if (!is_callable('smarty_function_script')) include 'C:/xampp/htdocs/test-ro/app/functions/smarty_plugins\\function.script.php';
if (!is_callable('smarty_function_split')) include 'C:/xampp/htdocs/test-ro/app/functions/smarty_plugins\\function.split.php';
if (!is_callable('smarty_function_math')) include 'C:\\xampp\\htdocs\\test-ro\\app\\lib\\vendor\\smarty\\smarty\\libs\\plugins\\function.math.php';
...
$_smarty_tpl->tpl_vars["vendor_id"] = new Smarty_variable($_smarty_tpl->tpl_vars['product']->value['company_id'], null, 0);
$_smarty_tpl->tpl_vars["show_price"] = new Smarty_variable(fn_is_necessary_to_show_price($_smarty_tpl->tpl_vars['vendor_id']->value), null, 0);
...
if ($_smarty_tpl->tpl_vars['show_price']->value=='off') {?><div class="ty-grid-list__price <?php if ($_smarty_tpl->tpl_vars['product']->value['price']==0) {?>ty-grid-list__no-price<?php }?>"><?php $_smarty_tpl->tpl_vars["old_price"] = new Smarty_variable("old_price_".((string)$_smarty_tpl->tpl_vars['obj_id']->value), null, 0);
...
} else { ?><div class="ty-grid-list__price <?php if ($_smarty_tpl->tpl_vars['product']->value['price']==0) {?>ty-grid-list__no-price<?php }?>"><?php $_smarty_tpl->tpl_vars["old_price"] = new Smarty_variable("old_price_".((string)$_smarty_tpl->tpl_vars['obj_id']->value), null, 0);
if (trim(Smarty::$_smarty_vars['capture'][$_smarty_tpl->tpl_vars['old_price']->value])) {
echo Smarty::$_smarty_vars['capture'][$_smarty_tpl->tpl_vars['old_price']->value];
}
$_smarty_tpl->tpl_vars["price"] = new Smarty_variable("price_".((string)$_smarty_tpl->tpl_vars['obj_id']->value), null, 0);
...
$_smarty_tpl->_capture_stack[0][] = array("product_multicolumns_list_control_data_wrapper", null, null); ob_start(); ?><div class="ty-grid-list__control"><?php $_smarty_tpl->_capture_stack[0][] = array("product_multicolumns_list_control_data", null, null); ob_start();
