<?php /* Smarty version Smarty-3.1.21, created on 2020-10-23 12:59:35
         compiled from "C:\xampp\htdocs\test-ro\design\themes\responsive\templates\common\product_data.tpl" */ ?>
<?php /*%%SmartyHeaderCode:8585253145f92a9877d02a8-59802884%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3a65add5b099a266dab007531673cf6add1defe0' => 
    array (
      0 => 'C:\\xampp\\htdocs\\test-ro\\design\\themes\\responsive\\templates\\common\\product_data.tpl',
      1 => 1603091483,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '8585253145f92a9877d02a8-59802884',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5f92a987e6e0f8_75724454',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f92a987e6e0f8_75724454')) {function content_5f92a987e6e0f8_75724454($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include 'C:/xampp/htdocs/test-ro/app/functions/smarty_plugins\\block.hook.php';
if (!is_callable('smarty_modifier_enum')) include 'C:/xampp/htdocs/test-ro/app/functions/smarty_plugins\\modifier.enum.php';
if (!is_callable('smarty_function_live_edit')) include 'C:/xampp/htdocs/test-ro/app/functions/smarty_plugins\\function.live_edit.php';
if (!is_callable('smarty_modifier_truncate')) include 'C:/xampp/htdocs/test-ro/app/functions/smarty_plugins\\modifier.truncate.php';
...
echo htmlspecialchars($_smarty_tpl->tpl_vars['obj_id']->value, ENT_QUOTES, 'UTF-8');?>
">
                        <?php if ($_smarty_tpl->tpl_vars['product']->value['min_qty']>0&&$_smarty_tpl->tpl_vars['product']->value['max_qty']==0) {?>
                            <?php $_smarty_tpl->tpl_vars['option'] = new Smarty_Variable;$_smarty_tpl->tpl_vars['option']->step = 1;$_smarty_tpl->tpl_vars['option']->total = (int) ceil(($_smarty_tpl->tpl_vars['option']->step > 0 ? $_smarty_tpl->tpl_vars['product']->value['amount']+1 - ($_smarty_tpl->tpl_vars['product']->value['min_qty']) : $_smarty_tpl->tpl_vars['product']->value['min_qty']-($_smarty_tpl->tpl_vars['product']->value['amount'])+1)/abs($_smarty_tpl->tpl_vars['option']->step));
if ($_smarty_tpl->tpl_vars['option']->total > 0) {
for ($_smarty_tpl->tpl_vars['option']->value = $_smarty_tpl->tpl_vars['product']->value['min_qty'], $_smarty_tpl->tpl_vars['option']->iteration = 1;$_smarty_tpl->tpl_vars['option']->iteration <= $_smarty_tpl->tpl_vars['option']->total;$_smarty_tpl->tpl_vars['option']->value += $_smarty_tpl->tpl_vars['option']->step, $_smarty_tpl->tpl_vars['option']->iteration++) {
$_smarty_tpl->tpl_vars['option']->first = $_smarty_tpl->tpl_vars['option']->iteration == 1;$_smarty_tpl->tpl_vars['option']->last = $_smarty_tpl->tpl_vars['option']->iteration == $_smarty_tpl->tpl_vars['option']->total;?>
                                <option><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['option']->value, ENT_QUOTES, 'UTF-8');?>
</option>
                            <?php }} ?>
                        <?php }?>
                        <?php if ($_smarty_tpl->tpl_vars['product']->value['min_qty']>0&&$_smarty_tpl->tpl_vars['product']->value['max_qty']>0) {?>
                            <?php $_smarty_tpl->tpl_vars['option'] = new Smarty_Variable;$_smarty_tpl->tpl_vars['option']->step = 1;$_smarty_tpl->tpl_vars['option']->total = (int) ceil(($_smarty_tpl->tpl_vars['option']->step > 0 ? $_smarty_tpl->tpl_vars['product']->value['max_qty']+1 - ($_smarty_tpl->tpl_vars['product']->value['min_qty']) : $_smarty_tpl->tpl_vars['product']->value['min_qty']-($_smarty_tpl->tpl_vars['product']->value['max_qty'])+1)/abs($_smarty_tpl->tpl_vars['option']->step));
if ($_smarty_tpl->tpl_vars['option']->total > 0) {
for ($_smarty_tpl->tpl_vars['option']->value = $_smarty_tpl->tpl_vars['product']->value['min_qty'], $_smarty_tpl->tpl_vars['option']->iteration = 1;$_smarty_tpl->tpl_vars['option']->iteration <= $_smarty_tpl->tpl_vars['option']->total;$_smarty_tpl->tpl_vars['option']->value += $_smarty_tpl->tpl_vars['option']->step, $_smarty_tpl->tpl_vars['option']->iteration++) {
$_smarty_tpl->tpl_vars['option']->first = $_smarty_tpl->tpl_vars['option']->iteration == 1;$_smarty_tpl->tpl_vars['option']->last = $_smarty_tpl->tpl_vars['option']->iteration == $_smarty_tpl->tpl_vars['option']->total;?>
                                <option><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['option']->value, ENT_QUOTES, 'UTF-8');?>
                            ...
                            <?php }} ?>
                        <?php }?>
                        <?php if ($_smarty_tpl->tpl_vars['product']->value['max_qty']>0&&$_smarty_tpl->tpl_vars['product']->value['min_qty']==0) {?> 
...
$_smarty_tpl->tpl_vars['smarty']->value['section']["qty"]['loop'] = is_array($_loop=$_smarty_tpl->tpl_vars['product']->value['max_qty']) ? count($_loop) : max(0, (int) $_loop); unset($_loop);
...
?>
                                <option><?php echo htmlspecialchars($_smarty_tpl->getVariable('smarty')->value['section']['qty']['iteration'], ENT_QUOTES, 'UTF-8');?>
</option>
                            <?php endfor; endif; ?>
                        <?php }?>
                        <?php if ($_smarty_tpl->tpl_vars['product']->value['min_qty']==0&&$_smarty_tpl->tpl_vars['product']->value['max_qty']==0) {?>
                            <?php if (isset($_smarty_tpl->tpl_vars['smarty']->value['section']["qty"])) unset($_smarty_tpl->tpl_vars['smarty']->value['section']["qty"]);
$_smarty_tpl->tpl_vars['smarty']->value['section']["qty"]['name'] = "qty";
$_smarty_tpl->tpl_vars['smarty']->value['section']["qty"]['loop'] = is_array($_loop=$_smarty_tpl->tpl_vars['product']->value['amount']) ? count($_loop) : max(0, (int) $_loop); unset($_loop);
$_smarty_tpl->tpl_vars['smarty']->value['section']["qty"]['show'] = true;
$_smarty_tpl->tpl_vars['smarty']->value['section']["qty"]['max'] = $_smarty_tpl->tpl_vars['smarty']->value['section']["qty"]['loop'];
$_smarty_tpl->tpl_vars['smarty']->value['section']["qty"]['step'] = 1;
$_smarty_tpl->tpl_vars['smarty']->value['section']["qty"]['start'] = $_smarty_tpl->tpl_vars['smarty']->value['section']["qty"]['step'] > 0 ? 0 : $_smarty_tpl->tpl_vars['smarty']->value['section']["qty"]['loop']-1;
