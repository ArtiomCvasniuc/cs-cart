<?php /* Smarty version Smarty-3.1.21, created on 2020-10-22 07:56:32
         compiled from "C:\xampp\htdocs\test-ro\design\backend\templates\common\tabsbox.tpl" */ ?>
<?php /*%%SmartyHeaderCode:9317332695f911100a89fe1-30570418%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '35f24afd57013a78a657c0880b287d2447ee7ac1' => 
    array (
      0 => 'C:\\xampp\\htdocs\\test-ro\\design\\backend\\templates\\common\\tabsbox.tpl',
      1 => 1601277434,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '9317332695f911100a89fe1-30570418',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5f911100b0fe55_77822659',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f911100b0fe55_77822659')) {function content_5f911100b0fe55_77822659($_smarty_tpl) {?><?php if (!is_callable('smarty_function_script')) include 'C:/xampp/htdocs/test-ro/app/functions/smarty_plugins\\function.script.php';
if (!is_callable('smarty_modifier_empty_tabs')) include 'C:/xampp/htdocs/test-ro/app/functions/smarty_plugins\\modifier.empty_tabs.php';
if (!is_callable('smarty_modifier_in_array')) include 'C:/xampp/htdocs/test-ro/app/functions/smarty_plugins\\modifier.in_array.php';
...
?>
        <?php if ((!$_smarty_tpl->tpl_vars['tabs_section']->value||$_smarty_tpl->tpl_vars['tabs_section']->value==$_smarty_tpl->tpl_vars['tab']->value['section'])&&($_smarty_tpl->tpl_vars['tab']->value['hidden']||!smarty_modifier_in_array($_smarty_tpl->tpl_vars['key']->value,$_smarty_tpl->tpl_vars['empty_tab_ids']->value))) {?>
            ...
            <?php if ($_smarty_tpl->tpl_vars['user_info']->value['user_type']=='V') {?>
                <?php if ($_smarty_tpl->tpl_vars['key']->value!='plan'&&$_smarty_tpl->tpl_vars['key']->value!='subscribers'&&$_smarty_tpl->tpl_vars['key']->value!='attachments'&&$_smarty_tpl->tpl_vars['key']->value!='addons'&&$_smarty_tpl->tpl_vars['key']->value!='reward_points'&&$_smarty_tpl->tpl_vars['key']->value!='required_products'&&$_smarty_tpl->tpl_vars['key']->value!='tags') {?>
