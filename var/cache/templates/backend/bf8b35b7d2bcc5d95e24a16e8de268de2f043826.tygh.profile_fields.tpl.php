<?php /* Smarty version Smarty-3.1.21, created on 2020-10-28 20:42:43
         compiled from "C:\xampp\htdocs\test-ro\design\backend\templates\views\profiles\components\profile_fields.tpl" */ ?>
<?php /*%%SmartyHeaderCode:16964607065f9110fcd989d0-62578919%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'bf8b35b7d2bcc5d95e24a16e8de268de2f043826' => 
    array (
      0 => 'C:\\xampp\\htdocs\\test-ro\\design\\backend\\templates\\views\\profiles\\components\\profile_fields.tpl',
      1 => 1603906962,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '16964607065f9110fcd989d0-62578919',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21',
  'unifunc' => 'content_5f9110fce6e918_24514114',
  'variables' => 
  array (
    'exclude' => 0,
    'include' => 0,
...
<?php if ($_valid && !is_callable('content_5f9110fce6e918_24514114')) {function content_5f9110fce6e918_24514114($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include 'C:/xampp/htdocs/test-ro/app/functions/smarty_plugins\\block.hook.php';
...
[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['data_id']->value, ENT_QUOTES, 'UTF-8');?>
 ...
 <?php if ($_smarty_tpl->tpl_vars['auth']->value['user_type']!='A') {?> disabled <?php }?> /></label>
...
echo $_smarty_tpl->tpl_vars['disabled_param']->value;
    ...
    <?php } else { ?>  
        <input
            <?php if ($_smarty_tpl->tpl_vars['field']->value['field_id']==57) {?>
                type="number"
            <?php } else { ?>
                type="text"
            <?php }?>
