<?php /* Smarty version Smarty-3.1.21, created on 2020-10-28 13:31:31
         compiled from "C:\xampp\htdocs\test-ro\design\backend\templates\views\profiles\manage.tpl" */ ?>
<?php /*%%SmartyHeaderCode:19071476185f914648c908e2-71528416%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '90498f8c6c1f76d2368521b854eb34df674fa97e' => 
    array (
      0 => 'C:\\xampp\\htdocs\\test-ro\\design\\backend\\templates\\views\\profiles\\manage.tpl',
      1 => 1603879913,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '19071476185f914648c908e2-71528416',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21',
  'unifunc' => 'content_5f914649062868_01916413',
  'variables' => 
  array (
    'search' => 0,
    'runtime' => 0,
...
<?php if ($_valid && !is_callable('content_5f914649062868_01916413')) {function content_5f914649062868_01916413($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_enum')) include 'C:/xampp/htdocs/test-ro/app/functions/smarty_plugins\\modifier.enum.php';
...
echo $_smarty_tpl->tpl_vars['c_dummy']->value;
        ...
        <th width="12%"><a class="cm-ajax" href="<?php echo htmlspecialchars(fn_url(((string)$_smarty_tpl->tpl_vars['c_url']->value)."&sort_by=last_login&sort_order=".((string)$_smarty_tpl->tpl_vars['search']->value['sort_order_rev'])), ENT_QUOTES, 'UTF-8');?>
" data-ca-target-id=<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['rev']->value, ENT_QUOTES, 'UTF-8');?>
...
echo $_smarty_tpl->tpl_vars['c_dummy']->value;
        ...
        <?php if ($_REQUEST['user_type']==smarty_modifier_enum("UserTypes::CUSTOMER")&&$_smarty_tpl->tpl_vars['can_view_orders']->value) {?>
            <th width="15%"><?php echo $_smarty_tpl->__("orders");?>
</th>
        <?php }?>
