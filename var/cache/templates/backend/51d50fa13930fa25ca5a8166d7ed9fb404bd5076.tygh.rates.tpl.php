<?php /* Smarty version Smarty-3.1.21, created on 2020-10-28 08:15:41
         compiled from "C:\xampp\htdocs\test-ro\design\backend\templates\views\shippings\components\rates.tpl" */ ?>
<?php /*%%SmartyHeaderCode:10585612265f98fe7d1d1c90-64368447%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '51d50fa13930fa25ca5a8166d7ed9fb404bd5076' => 
    array (
      0 => 'C:\\xampp\\htdocs\\test-ro\\design\\backend\\templates\\views\\shippings\\components\\rates.tpl',
      1 => 1599553797,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '10585612265f98fe7d1d1c90-64368447',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5f98fe7d3349b0_96985254',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f98fe7d3349b0_96985254')) {function content_5f98fe7d3349b0_96985254($_smarty_tpl) {?><?php if (!is_callable('smarty_function_script')) include 'C:/xampp/htdocs/test-ro/app/functions/smarty_plugins\\function.script.php';
...
]" value="Y" <?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['rdf']['first']) {?>disabled="disabled"<?php }?> class=" cm-item-cost-<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['destination_id']->value, ENT_QUOTES, 'UTF-8');?>
 cm-item" /></td>
                            <td class="nowrap">
...
]" value="Y" <?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['rdf']['first']) {?>disabled="disabled"<?php }?> class=" cm-item-weight-<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['destination_id']->value, ENT_QUOTES, 'UTF-8');?>
 cm-item" /></td>
                            <td class="nowrap">
                                <?php echo $_smarty_tpl->__("more_than");?>
&nbsp;
...
]" value="Y" <?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['rdf']['first']) {?>disabled="disabled"<?php }?> class=" cm-item-items-<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['destination_id']->value, ENT_QUOTES, 'UTF-8');?>
 cm-item" /></td>
                            <td class="nowrap">
                                <?php echo $_smarty_tpl->__("more_than");?>
&nbsp;
